1.电子邮件软件:MUA(Mail User Agent——邮件用户代理)
2.Email服务提供商:MTA(Mail Transfer Agent——邮件传输代理)
3.目标邮箱：MDA(Mail Delivery Agent——邮件投递代理)
...
(2).IMAP：Internet Message Access Protocol，目前版本是4
